...
public class GuavaObserver2 {
    ...
    public void getSubscribe(UserModel userModel){
        System.out.println("今天参加活动的员工为："+userModel.getUserName());
        System.out.println("年龄为："+userModel.getAge());
        System.out.println("活动内容为："+userModel.getContext());
    }
    ...
    public void gettest(String str){
        System.out.println("今天参加活动的学员为："+str);
    }
}
